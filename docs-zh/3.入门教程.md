...
<div style="display:flex; flex-direction: row; height: 400px; max-height: 500px">
    <div style="width: 35%; height: 100%;" class="pic-container">
        <img src="../examples/code-property-graph/cfg.png" alt="图片1" object-fit="contain">
        <div class="v-spacer"></div>
        <p><b>控制流图（CFG）</b></p>
    </div>
    <div style="width: 65%; height: 100%;" class="pic-container">
...
<div style="display:flex; flex-direction: row; height: 400px">
    <div style="width: 50%; height: 100%;" class="pic-container">
